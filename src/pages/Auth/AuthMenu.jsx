    ...
    return (
        <div className={`flex justify-column align-middle py-1 px-4`}>
            <div className='pt-[4px]'>
                <span className={`rounded-full border-2 border-[#d05613]
                    inline-flex items-center justify-center 
                    h-6 w-6 sm:h-8 sm:w-8 ring-white text-white 
                    bg-[#da4e00] overflow-hidden`}>
                    <i className="fa-duotone fa-user fa-fw pt-2 text-2xl" aria-hidden="true"></i>
                </span>
            </div>
            
            <span className='pl-2'>
                <div className='text-md font-thin tracking-tighter  text-left text-[#da4e00] group-hover:text-white '>{user.email ? user.email : ''}</div>
...
export const Item = (to, icon, span, condition) => (
    condition === undefined || condition ?
        <Link to={ to } >
            <div className='px-6 py-1 bg-[#da4e00] text-white hover:text-blue-100'>
    ...
    return (
        <div className="h-full w-fit">
            {!user.authed ?
                ...
                <Dropdown control={<UserMenu user={user}/>} className={`hover:bg-[#da4e00] group `} >
                    <div className='p-1 bg-[#da4e00]'>
                        { user.authLevel >= 5 ? 
                        <div className='py-2'>
                            <div className=''> 
                                {Item('/manage/templates', 'fad fa-screwdriver-wrench fa-fw flex-shrink-0  pr-1', 'Templates')}
                            </div>
                            <div className=''> 
                        ...
                        : ''}
                        <div className='py-1 border-t border-[#d05613]'> 
